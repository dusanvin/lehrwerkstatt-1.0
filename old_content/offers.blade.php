                    ...
                    <form action="{{ route('offers') }}" method="post" class="mb-4">
                        ...
                        <div class="grid grid-cols-3 gap-4">
                            ...
                            <div class="grid grid-cols-1 text-sm text-gray-500 text-light mt-3">
                                ...
                                <p class="text-xs text-gray-500 mt-1 mb-3">Bestimmen Sie, welche Schulart Sie präferieren.</p>

                                <div>

                                    <label for="sprachkenntnisse" class="sr-only flex items-center">schulart</label>

                                    <select name="schulart" id="schulart" class="text-gray-500 text-xs py-1 px-1 rounded-sm border-2 border-purple-300 focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent @error('schulart') border-red-500 @enderror">
                                        <option>Keine</option>
                                    ...
                                    @error('schulart')
                                        ...
                                        <div class="text-red-500 mt-2 text-sm">
                                            ...
                                            {{ 'Bitte bestimmen Sie, welche Schulart Ihr Betreuungsverhältnis haben sollte.' }}
