...
function exportAllStudCSV() {

    let csv = [

        [
            'Liste aller registrierten Studierenden nach Schulart sortiert.'
        ],
    ...
    url = URL.createObjectURL(file);
    csv_link = document.getElementById('csv_link_all_stud');
    csv_link.setAttribute('href', url);
    csv_link.setAttribute('download', 'Studierende.csv')
