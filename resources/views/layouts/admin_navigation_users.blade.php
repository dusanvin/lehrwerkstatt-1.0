@if (Auth::user()->getRoleNames()[0] === 'Admin')
    ...
    <div class="bg-white px-6 py-4">
        ...
        <nav class="flex flex-col sm:flex-row text-sm">
            ...
            <a href="{{ route('roles.index') }}" class="font-medium text-gray-500 py-4 px-6 inline-block focus:border-purple-300 focus:text-purple-500 focus:outline-none hover:text-purple-500 hover:border-purple-300 border-b-2 border-gray-300">
