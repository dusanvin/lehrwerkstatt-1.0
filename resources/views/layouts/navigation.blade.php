		...
		<div class="mt-10 pt-3">
				...
				<li class="ml-2 mr-2 my-1 rounded-l-lg rounded-r-lg">
					...
					<a href="{{ route('profile.matchings') }}" class="text-gray-100 hover:text-gray-400 px-4 py-2 flex items-center rounded-l-md rounded-r-md transition ease-in-out duration-150 @if (Request::is('profile/matchings')) { text-yellow-400 } @endif">
						...
						<div>
							...
							<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="fillcurrent h-5 w-5">
			...
			<ul>
				...
				<li class="ml-2 mr-2 my-1 rounded-l-lg rounded-r-lg">
					...
					<a href="{{ route('users.lehr') }}" class="text-gray-100 hover:text-gray-400 px-4 py-2 flex items-center rounded-l-md rounded-r-md transition ease-in-out duration-150 @if (Request::is('angebote/*')) { text-yellow-400 } @endif">
				...
				<li class="ml-2 mr-2 my-1 rounded-l-lg rounded-r-lg">
					...
					<a href="{{ route('users.stud') }}" class="text-gray-100 hover:text-gray-400 px-4 py-2 flex items-center rounded-l-md rounded-r-md transition ease-in-out duration-150 @if (Request::is('bedarfe/*')) { text-yellow-400 } @endif">
