...
<nav class="bg-top bg-gray-700 w-80 justify-between flex flex-col sm:rounded-l-lg shadow-b transition ease-in-out duration-150" id="navigation-digillab">
	...
	<div class="mt-10 mb-10">
		...
		<div class="mt-10 pt-3">
				...
				<li class="ml-2 mr-2 my-1 rounded-l-lg rounded-r-lg">
					...
					<a href="{{ route($route_name) }}" class="text-gray-300 hover:text-white px-4 py-2 flex items-center rounded-l-md rounded-r-md transition ease-in-out duration-150 @if (Request::routeIs($route_name)) { text-yellow-400 } @endif">
						...
						<div class="pl-3">
							...
							<p class="navigation-element text-sm font-semibold">Vorschläge ({{ count(Auth::user()->matchings) }})</p>
				...
				<li class="ml-2 mr-2 my-1 rounded-l-lg rounded-r-lg">
					...
					<a href="{{ route($route_name) }}" class="text-gray-300 hover:text-white px-4 py-2 flex items-center rounded-l-md rounded-r-md transition ease-in-out duration-150 @if (Request::routeIs($route_name)) { text-yellow-400 } @endif">
						...
						<div class="pl-3">
							...
							<p class="navigation-element text-sm font-semibold">{{ Config::get('site_vars.nachrichten') }}</p>
				...
				<li class="ml-2 mr-2 my-1 rounded-l-lg rounded-r-lg">
					...
					<a href="{{ route($route_name) }}" class="text-gray-300 hover:text-white px-4 py-2 flex items-center rounded-l-md rounded-r-md transition ease-in-out duration-150 @if (Request::routeIs($route_name)) { text-yellow-400 } @endif">
						...
						<div class="pl-3">
							...
							<p class="navigation-element text-sm font-semibold">{{ Config::get('site_vars.verwaltung') }}</p>
				...
				<li class="ml-2 mr-2 my-1 rounded-l-lg rounded-r-lg">
					...
					<a href="{{ route($route_name) }}" class="text-gray-300 hover:text-white px-4 py-2 flex items-center rounded-l-md rounded-r-md transition ease-in-out duration-150 @if (Request::routeIs($route_name)) { text-yellow-400 } @endif">
						...
						<div class="pl-3">
							...
							<p class="navigation-element text-sm font-semibold">{{ Config::get('site_vars.vorschlaege') }}</p>
				...
				<li class="ml-2 mr-2 my-1 rounded-l-lg rounded-r-lg">
					...
					<a href="{{ route($route_name) }}" class="text-gray-300 hover:text-white px-4 py-2 flex items-center rounded-l-md rounded-r-md transition ease-in-out duration-150 @if (Request::routeIs($route_name)) { text-yellow-400 } @endif">
						...
						<div class="pl-3">
							...
							<p class="navigation-element text-sm font-semibold">{{ Config::get('site_vars.paarungen') }}</p>
			...
			<p class="navigation-element mb-3 mt-10 pl-7 text-xs tracking-wider text-gray-300 antialiased uppercase font-medium">Angebote</p>
				...
				<li class="ml-2 mr-2 my-1 rounded-l-lg rounded-r-lg">
					...
					<a href="{{ route($route_name) }}" class="text-gray-300 hover:text-white px-4 py-2 flex items-center rounded-l-md rounded-r-md transition ease-in-out duration-150 @if (Request::routeIs($route_name)) { text-yellow-400 } @endif">
						...
						<div class="pl-3">
							...
							<p class="navigation-element text-sm font-semibold">{{ Config::get('site_vars.angebote') }}</p>
				...
				<li class="ml-2 mr-2 my-1 rounded-l-lg rounded-r-lg">
					...
					<a href="{{ route($route_name) }}" class="text-gray-300 hover:text-white px-4 py-2 flex items-center rounded-l-md rounded-r-md transition ease-in-out duration-150 @if (Request::routeIs($route_name)) { text-yellow-400 } @endif">
						...
						<div class="pl-3">
							...
							<p class="navigation-element text-sm font-semibold">{{ Config::get('site_vars.bedarfe') }}</p>
