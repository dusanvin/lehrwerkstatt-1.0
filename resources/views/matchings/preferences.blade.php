        ...
        <div class="mx-auto rounded">
            ...
            <ul id="tabs" class="inline-flex w-full">
                ...
                <li
                    ...
                    <a href="{{ route('matchings.preferences') }}">Alle Schularten</a></li>
                ...
                <li
                    ...
                    <a href="{{ route('matchings.preferences', ['schulart' => 'grundschule']) }}">Grundschule</a></li>
                ...
                <li
                    ...
                    <a href="{{ route('matchings.preferences', ['schulart' => 'realschule']) }}">Realschule</a></li>
                ...
                <li
                    ...
                    <a href="{{ route('matchings.preferences', ['schulart' => 'gymnasium']) }}">Gymnasium</a></li>
            ...
            <div class="px-1 md:px-8 py-1 md:py-8 text-gray-700 w-screen sm:rounded-r-lg bg-gray-900">
                ...
                <h1>{{ $schulart ? ucfirst($schulart) : 'Alle Schularten' }}, Nutzer die ein Wunschfeld ausgefüllt haben.</h1>
                            ...
                            <tbody>
                                ...
                                @if (count($matched_lehr) == 0)
                                    <p
                                        ...
                                        Bisher wurden keine Vorschläge von Ihnen übernommen. Suchen Sie auf Basis des MSE
                                        nach
                                        Paarungen.</p>
                    ...
                    <div class="bg-gray-800 px-1 md:px-8 py-1 md:py-8 rounded-md mt-4">
                        ...
                        <div class="grid justify-items-center sm:justify-items-start select-none">
                            ...
                            <div class="mt-1 text-sm text-gray-300 grid text-center sm:text-left flex">
                                ...
                                @if (count($matchings_lehr_stud_wunschtandem) == 0)
                                    <p>Keine Vorschläge vorhanden.</p>
                                @elseif (count($matchings_lehr_stud_wunschtandem) == 1)
                                    <p>
                                        Es gibt einen Vorschlag.
                                    </p>
                                @elseif (count($matchings_lehr_stud_wunschtandem) > 1)
                                    <p>
                                        Es gibt {{ count($matchings_lehr_stud_wunschtandem) }} Vorschläge.
                                    </p>
                                @endif
                        ...
                        <table class="min-w-full mt-4 mb-2 mr-4 shadow-sm rounded-lg">
                            ...
                            <tbody>
                                ...
                                @if (count($matchings_lehr_stud_wunschtandem) > 0)
                                    ...
                                    @foreach ($matchings_lehr_stud_wunschtandem as $index => $matching)
                                        <tr class="border-t border-gray-200 bg-gray-700">
                    ...
                    <div class="bg-gray-800 px-1 md:px-8 py-1 md:py-8 rounded-md mt-4">
                        ...
                        <div class="grid justify-items-center sm:justify-items-start select-none">
                            ...
                            <div class="mt-1 text-sm text-gray-300 grid text-center sm:text-left flex">
                                ...
                                @if (count($matchings_stud_lehr_wunschtandem) == 0)
                                    <p>Keine Vorschläge vorhanden.</p>
                                @elseif (count($matchings_stud_lehr_wunschtandem) == 1)
                                    <p>
                                        Es gibt einen Vorschlag.
                                    </p>
                                @elseif (count($matchings_stud_lehr_wunschtandem) > 1)
                                    <p>
                                        Es gibt {{ count($matchings_stud_lehr_wunschtandem) }} Vorschläge.
                                    </p>
                                @endif
                        ...
                        <table class="min-w-full mt-4 mb-2 mr-4 shadow-sm rounded-lg">
                            ...
                            <tbody>
                                ...
                                @if (count($matchings_stud_lehr_wunschtandem) > 0)
                                    ...
                                    @foreach ($matchings_stud_lehr_wunschtandem as $index => $matching)
                                        <tr class="border-t border-gray-200 bg-gray-700">
