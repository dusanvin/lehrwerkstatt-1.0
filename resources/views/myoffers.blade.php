...
<div class="flex flex-row h-full mx-5 mt-10 mb-10">
    ...
    <div class="px-8 py-8 text-gray-700 w-screen rounded-r-lg" style="background-color: #EDF2F7;">
        ...
        <div class="mx-auto rounded">
            ...
            <li class="px-4 py-2 -mb-px font-medium text-sm text-gray-800 border-b-2 border-gray-700 rounded-t opacity-50 bg-white border-b-4 -mb-px opacity-100"><a href="{{ route('myoffers') }}">Meine Angebote</a></li>

            <li class="px-4 py-2 font-medium text-sm text-gray-800 rounded-t opacity-50 bg-white border-gray-400"><a href="{{ route('makeoffer') }}">Angebot erstellen</a></li>
