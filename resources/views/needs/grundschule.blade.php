    ...
    <div class="px-1 md:px-8 py-1 md:py-8 text-gray-700 w-screen sm:rounded-r-lg bg-gray-600">
        ...
        <div class="mx-auto rounded">
            ...
            <ul id="tabs" class="inline-flex w-full">
                ...
                <li class="px-4 py-2 font-medium text-xs sm:text-sm text-gray-800 rounded-t opacity-50 bg-white border-gray-400"><a href="{{ route('users.stud') }}">Alle Schularten</a></li>

                <li class="px-4 py-2 -mb-px font-medium text-xs sm:text-sm text-gray-800 border-b-2 border-gray-700 rounded-t opacity-50 bg-white border-b-4 -mb-px opacity-100"><a href="{{ route('users.stud', ['schulart' => 'grundschule']) }}">Grundschule</a></li>
                                ...
                                <form id="search" action="{{ route('users.stud', ['schulart' => 'Grundschule']) }}" method="post">
                                    ...
                                    <div class="grid grid-cols-1 gap-4 lg:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4 mb-6">
                                        ...
                                        <select hidden name="schulart" id="schulart" class="text-gray-500 text-xs py-1 px-2 rounded-sm border-2 border-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-600 focus:border-transparent @error('schulart') border-red-500 @enderror">
                                            <option selected>Grundschule</option>
                                        </select>
