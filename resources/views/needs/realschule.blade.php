    ...
    <div class="px-1 md:px-8 py-1 md:py-8 text-gray-700 w-screen sm:rounded-r-lg bg-gray-900">
        ...
        <div class="mx-auto rounded">
            ...
            <ul id="tabs" class="inline-flex w-full">
                ...
                <li class="px-4 py-2 -mb-px font-medium text-xs sm:text-sm text-gray-200 border-b-2 border-gray-700 rounded-t opacity-50 bg-gray-800 border-b-4 -mb-px opacity-100"><a href="{{ route('users.stud', ['schulart' => 'realschule']) }}">Realschule</a></li>

                <li class="px-4 py-2 font-medium text-xs sm:text-sm text-gray-200 rounded-t opacity-50 bg-gray-800 border-gray-800 hover:bg-gray-600"><a href="{{ route('users.stud', ['schulart' => 'gymnasium']) }}">Gymnasium</a></li>
                ...
                <div id="first" class="px-4 pt-4 pb-2 bg-gray-800 mb-4 rounded-b-md">
                    ...
                    <div class="grid grid-cols-1 text-sm text-gray-500 text-light py-1 my-2 px-1 md:px-4">
                        ...
                        <div class="mt-1 mb-6 text-sm text-gray-300 grid text-center sm:text-left flex">
                            ...
                            <p>Hier erhalten Sie eine Übersicht zu den momentan aktiven Angeboten an der <span class="font-semibold">Realschule</span>. Die Darstellung erfolgt in Abhängigkeit Ihrer Suchkriterien. Sollten keine Kriterien ausgewählt werden, erfolgt keine Filterung.</p>
                        ...
                        <div class="flex flex-col">
                            ...
                            <div class="bg-gray-700 my-4 shadow-sm rounded-md" x-data="accordion(1)">
                                ...
                                <div x-ref="tab" :style="handleToggle()" class="overflow-hidden max-h-0 duration-500 transition-all px-6">
                                    ...
                                    <form id="search" action="{{ route('users.stud', ['schulart' => 'realschule']) }}" method="post">
