                        ...
                        <table class="min-w-full my-4 mr-4 shadow-sm rounded-lg">
                            ...
                            <tr class="border-t border-gray-200">
                                ...
                                <td class="px-6 py-4 whitespace-no-wrap ">
                                    ...
                                    <label class="inline-flex items-center justify-center px-3 py-2 mr-2 text-xs font-medium leading-none text-white {{ $need->assigned ? 'bg-yellow-400' : 'bg-green-600' }} rounded-full">

                                        <span class="has-tooltip">

                                            {{ $need->assigned ? 'Vergeben' : 'Aktiv' }}
                                            ...
                                            <div class="h-auto p-4 mx-10 text-left bg-white rounded shadow-xl max-w-screen-sm" @click.away="open = false">
                                                ...
                                                <div class="mt-3 text-center sm:text-left">
                                                    ...
                                                    <div class="mt-2">
                                                        ...
                                                        <p class="leading-5 text-gray-500 mb-2 text-xs">
                                                            <span class="font-medium">{{ $need->interessen }}</span>
                                                        </p>
