    ...
    <div class="flex flex-row h-full mx-5 mt-10 mb-10">
        ...
        <div class="px-8 py-8 text-gray-700 w-screen rounded-r-lg" style="background-color: #EDF2F7;">
            ...
            <ul id="tabs" class="inline-flex w-full">
                ...
                <li class="px-4 py-2 -mb-px font-medium text-sm text-gray-800 border-b-2 border-gray-400 rounded-t opacity-50 bg-white"><a id="default-tab" href="#first">Alle Angebote</a></li>

                <li class="px-4 py-2 font-medium text-sm text-gray-800 rounded-t opacity-50 bg-white border-gray-400"><a href="#second">Meine Angebote</a></li>

                <li class="px-4 py-2 font-medium text-sm text-gray-800 rounded-t opacity-50 bg-white border-gray-400"><a href="#third">Angebot erstellen</a></li>
