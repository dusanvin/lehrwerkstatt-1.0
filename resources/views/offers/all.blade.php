                ...
                <div id="tab-contents">
                            ...
                            <div class="flex flex-col">
                                ...
                                <div class="bg-gray-700 my-4 shadow-sm rounded-md" x-data="accordion(1)">
                                    ...
                                    <h2 @click="handleClick()"
                                        class="flex flex-row justify-between items-center px-4 cursor-pointer text-sm text-gray-300 px-6 py-6 hover:text-gray-200">
                                    ...
                                    <div x-ref="tab" :style="handleToggle()"
                                        ...
                                        <form id="search" action="{{ route('users.lehr') }}" method="post">
                                                        ...
                                                        <ul class="list-group">
                                                            @foreach ($landkreise as $landkreis)
                                                                <li class="list-group-item mb-1">
                                                                    <input class="form-check-input me-1 bg-gray-800 mr-1"
                                                                        type="checkbox" value="{{ $landkreis }}"
                                                                        id="{{ $landkreis }}"
                                                                        onclick="addLandkreisToSelection(this.value, this.checked)">
                                                    ...
                                                    <div class="flex relative flex-wrap">
                                                        ...
                                                        <ul class="list-group">
                                                            @foreach ($faecher as $fach)
                                                                <li class="list-group-item mb-1">
                                                                    <input class="form-check-input me-1 bg-gray-800 mr-1"
                                                                        type="checkbox" value="{{ $fach }}"
                                                                        id="{{ $fach }}"
                                                                        onclick="addToSelection(this.value, this.checked)">
                                            ...
                                            <div class="flex justify-end md:gap-8 gap-4 pt-1 rounded-md text-sm mb-4">
                                                ...
                                                <button
                                                    class="bg-yellow-700 bg-transparent hover:bg-green-600 text-white font-semibold text-sm hover:text-white py-2 pr-4 pl-3 border border-transparent focus:outline-none focus:ring ring-green-300 focus:border-green-300 rounded flex items-center transition ease-in-out duration-150"
                                                    form="search">
                    ...
                    <div class="bg-gray-800 px-1 md:px-8 py-1 md:py-8 rounded-md mt-4">
                        ...
                        <div class="flex justify-end">
                            ...
                            <a onclick="exportCSV()" id="csv_link" href="#" class="bg-yellow-600 hover:bg-yellow-700 text-white font-semibold text-sm hover:text-white py-2 pr-4 pl-3 border border-yellow-700 hover:border-transparent focus:outline-none focus:ring ring-yellow-300 focus:border-yellow-300 rounded flex items-center transition-colors duration-200 transform duration-150 hover:scale-105 transform has-tooltip">
                                ...
                                <span class="tooltip rounded p-1 px-2 bg-gray-900 text-white -mt-20 -ml-2 text-xs font-normal" style="font-size: 12px;">Exportieren</span>
                        ...
                        <div class="min-w-full mt-4 mr-4 shadow-sm">
                            ...
                            <p
                                ...
                                Auflistung von kompatiblen Angeboten</p>
                            ...
                            <div class="border-b border-gray-200 bg-gray-700 flex">
                                ...
                                <div class="px-6 py-4 w-1/4">
                                    ...
                                    <div class="text-xs sm:text-sm leading-5 font-medium text-white w-64">
                                        ...
                                        <a href="{{ route('profile.details', ['id' => $user->id]) }}"
                                            class="text-xs sm:text-sm leading-5 font-medium text-white hover:underline break-all">
                                    ...
                                    <a href="mailto:{{ $user->email }}"
                                        class="text-xs sm:text-sm leading-5 text-gray-400 hover:text-gray-100 break-all">{{ $user->email }}
                                    </a>
                                            ...
                                            <div
                                                ...
                                                <div x-cloak x-show="modelOpen"
                                                    ...
                                                    <div class="flex items-center justify-between space-x-4">
                                                        ...
                                                        <h1 class="text-xl font-medium text-gray-100">Angebot
                                                            #{{ $user->id }}</h1>

                                                        <button @click="modelOpen = false"
                                                            class="text-gray-400 focus:outline-none hover:text-gray-100">
                                                    ...
                                                    <div class="mt-4">
                                                        ...
                                                        <h3 class="text-xs font-medium text-white uppercase">Informationen
                                                            zur Schule</h3>
                                                        ...
                                                        <div class="pb-4 w-full mt-3">
                                                            ...
                                                            <div class="text-xs sm:text-sm leading-5 w-full text-gray-400">
                                                                ...
                                                                <p
                                                                    class="text-gray-300 text-xs text-left leading-4 uppercase font-medium mb-1">
                                                                    {{ $user->survey_data->schulart }}</p>

                                                                {{ $user->survey_data->schulname }},
                                                                {{ $user->survey_data->strasse }}
                                                                {{ $user->survey_data->hausnummer }} in
                                                                {{ $user->survey_data->postleitzahl }}
                                                                {{ $user->survey_data->ort }} (Landkreis
                                                                {{ $user->survey_data->landkreis }})
                                                        ...
                                                        <div>
                                                            ...
                                                            <h3 class="text-xs font-medium text-white uppercase">
                                                                Informationen zur Zusammenarbeit</h3>
                                                            ...
                                                            <div class="w-full mt-3 text-sm text-gray-400">
                                                                ...
                                                                <p
                                                                    class="text-gray-300 text-xs leading-4 uppercase font-medium mb-1">
                                                                    Feedback von Lehrkraft</p>

                                                                <p>

                                                                    Das Feedback, das ich meinem Lehr:werker bzw. meiner
                                                                    Lehr:werkerin gebe:
                                                                    ...
                                                                    @switch($user->survey_data->feedback_an)
                                                                        ...
                                                                        @case('3')
                                                                            <span class="status">ist manchmal behutsam, manchmal
                                                                                direkt.</span>
                                                                        @break
                                                            ...
                                                            <div class="w-full mt-3 text-sm text-gray-400">
                                                                ...
                                                                <p
                                                                    class="text-gray-300 text-xs leading-4 uppercase font-medium mb-1">
                                                                    Feedback von Tandempartner*in</p>

                                                                <p>

                                                                    Ich wünsche mir von meinem Lehr:werker bzw. meiner
                                                                    Lehr:werkerin kritische Rückmeldungen zu meinem
                                                                    Unterricht:
                                                            ...
                                                            <div class="w-full mt-3 text-sm text-gray-400">
                                                                ...
                                                                <p>
                                                                    ...
                                                                    Mein*e Lehr:werker*in soll langsam ins selbstständige
                                                                    Unterrichten hineinwachsen und nicht von Anfang an Teile
                                                                    des Unterrichts übernehmen:
                                                            ...
                                                            <div class="w-full mt-3 text-sm text-gray-400">
                                                                ...
                                                                <p>
                                                                    ...
                                                                    Situationen, in denen ich improvisieren muss, versuche
                                                                    ich durch intensive Planung strikt zu vermeiden:
                                                            ...
                                                            <div class="w-full mt-3 text-sm text-gray-400">
                                                                ...
                                                                <p>
                                                                    ...
                                                                    @switch($user->survey_data->freiraum)
                                                                        @case('1')
                                                                            <span class="status">mir eher Freiraum für eigene Ideen
                                                                                und Entscheidungen lässt.</span>
                                                                        @break

                                                                        @case('2')
                                                                            <span class="status">mir teils Freiraum lässt, teils
                                                                                klare Anweisungen gibt.</span>
                                                                        @break

                                                                        @case('3')
                                                                            <span class="status">mir eher klare Anweisungen
                                                                                gibt.</span>
                                                                        @break
                                                            ...
                                                            <div class="w-full mt-3 text-sm text-gray-400">
                                                                ...
                                                                <p
                                                                    class="text-gray-300 text-xs leading-4 uppercase font-medium mb-1">
                                                                    Innovationsoffenheit</p>

                                                                <p>

                                                                    Ich möchte lieber meine Erfahrungen an den bzw. die
                                                                    Lehr:werker*in weitergeben als gemeinsam mit ihm bzw.
                                                                    ihr Neues auszuprobieren:
                                                            ...
                                                            <div class="w-full mt-3 text-sm text-gray-400">
                                                                ...
                                                                <p>
                                                                    ...
                                                                    Ich wünsche mir eine*n Lehr:werker*in, die bzw. der sich
                                                                    das Unterrichten in schwierigen bzw. höheren Klassen
                                                                    zutraut:
                                                        ...
                                                        <div class="mt-4 flex">
                                                            ...
                                                            <form action="/messages/create/{{ $user->id }}"
                                                                ...
                                                                <input
                                                                    class="py-2 px-3 bg-gray-100 border-1 w-full rounded-sm form-control form-input"
                                                                    placeholder="Ihr Betreff."
                                                                    value="Anfrage zu Angebot #{{ $user->id }}"
                                                                    name="subject" type="hidden">
