                    ...
                    <div class="bg-white overflow-hidden rounded-b-md mb-5">
                        ...
                        <div class="px-2 py-5 sm:px-4">
                            ...
                            <div class="grid grid-cols-1 text-sm text-gray-500 text-light py-1 my-1">
                                ...
                                <p class="font-medium text-gray-800 leading-none text-lg leading-6">Angebotsänderung</p>

                                <p class="text-sm text-gray-500 mt-1 mb-3 mt-2">Hier haben Sie die Möglichkeit, die Angaben zu Ihrem Angebot zu ändern.</p>
                            ...
                            <form action="{{ route('offers') }}" method="post" class="mb-4">
                                ...
                                <div class="mt-1">
                                    ...
                                    <div class="text-red-500 mt-2 text-sm">
                                        ...
                                        {{ 'Ändern Sie Ihre Beschreibung des Hilfsangebots.' }}
                                ...
                                <div class="grid grid-cols-1 gap-4 lg:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4">
                                    ...
                                    <div class="grid grid-cols-1 text-sm text-gray-500 text-light mt-3">
                                        ...
                                        <p class="text-xs text-gray-500 mt-1 mb-3">Ändern Sie, wieviele Personen Sie betreuen möchten.</p>
                                    ...
                                    <div class="grid grid-cols-1 text-sm text-gray-500 text-light mt-3">
                                        ...
                                        <p class="text-xs text-gray-500 mt-1 mb-3">Ändern Sie Ihren Betreuungszeitraum.</p>
                                        ...
                                        <script type="text/javascript">
                                            flatpickr("#datum", {
                                                ...
                                                mode: "range",
                                                "locale": "de",
                                                defaultDate: ["{{ $offer->datum_start}}", "{{ $offer->datum_end}}"]
                                            });
                                        </script>
                                    ...
                                    <div class="grid grid-cols-1 text-sm text-gray-500 text-light mt-3">
                                        ...
                                        <p class="text-xs text-gray-500 mt-1 mb-3">Wählen Sie Ihr aktuelles Fachsemester aus.</p>
