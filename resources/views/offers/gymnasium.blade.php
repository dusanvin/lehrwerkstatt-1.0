    ...
    <div class="px-1 md:px-8 py-1 md:py-8 text-gray-700 w-screen sm:rounded-r-lg bg-gray-900">
        ...
        <div class="mx-auto rounded">
            ...
            <ul id="tabs" class="inline-flex w-full">
                ...
                <li class="px-4 py-2 -mb-px font-medium text-xs sm:text-sm text-gray-200 border-b-2 border-gray-700 rounded-t opacity-50 bg-gray-800 border-b-4 -mb-px opacity-100"><a href="{{ route('users.lehr', ['schulart' => 'gymnasium']) }}">Gymnasium</a></li>
