            ...
            <div class="bg-white shadow overflow-hidden sm:rounded-lg mb-4">
                ...
                <div class="px-4 py-5 sm:px-6">
                    ...
                    <p class="mt-1 text-sm text-gray-500">
                        ...
                        Registrieren Sie eine neue Personen. Die Daten sind für <strong>Moderierende</strong> und <strong>Administrierende</strong> einseh- und bearbeitbar.
                            ...
                            <dl>
                                ...
                                <div class="px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                    ...
                                    <dt class="text-sm font-medium text-gray-500 py-2">
                                      ...
                                      Legen Sie den <strong>Vornamen</strong> der Person fest
                                ...
                                <div class="px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                    ...
                                    <dt class="text-sm font-medium text-gray-500 py-2">
                                      ...
                                      Legen Sie den <strong>Nachnamen</strong> der Person fest
                                ...
                                <div class="px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                    ...
                                    <dt class="text-sm font-medium text-gray-500 py-2">
                                      ...
                                      Legen Sie die <strong>E-Mail-Adresse</strong> der Person fest
                                ...
                                <div class="px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                    ...
                                    <dt class="text-sm font-medium text-gray-500 py-2">
                                      ...
                                      Vergeben Sie ein <strong>Passwort</strong> für die Person
                                ...
                                <div class="px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                    ...
                                    <dt class="text-sm font-medium text-gray-500 py-2">
                                      ...
                                      <strong>Bestätigen</strong> Sie das <strong>Passwort</strong> der Person
                                ...
                                <div class="px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                    ...
                                    <dd class="mt-1 text-sm text-gray-500 text-white hover:text-gray-900 active:text-gray-1000 sm:mt-0 sm:col-span-2 flex items-center border-b-2">
                                        ...
                                        {!! Form::select('roles[]', $roles,[], array('class' => 'w-full px-2 py-2 ml-2 border-b-2 border-gray-200 focus:outline-none focus:text-gray-900 transition ease-in-out duration-500','multiple')) !!}
